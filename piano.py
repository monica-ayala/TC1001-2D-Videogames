...
from functools import partial  #para permitirnos llamar una función con args desde button.clicked.connect
from music21 import *
import random
...
"font: 26pt \"MS Gothic\";")
    ...
    #Dependiendo del botón presionado se crea y reproduce la nota correspondiente     
    def button_click(self,button):
        ...
        #Código sacado de http://web.mit.edu/music21/doc/moduleReference/moduleMidiRealtime.html
    ...
    def button_recall(self,button):
        ...
        #permite reproducir el stream a, stream global que guarda todo lo que ha sido tocado
